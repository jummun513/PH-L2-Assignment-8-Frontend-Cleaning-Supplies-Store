    ...
    <Box component="footer" bgcolor="primary.main">
      <Container>
        <Grid
          ...
          style={{ margin: "0px" }}
          padding={{ xs: "60px 0 30px 0", md: "80px 0 40px 0" }}
        >
        ...
        <Divider variant="fullWidth" sx={{ bgcolor: "#D1D5DB" }}></Divider>
        <Stack
          padding={{ xs: "16px 0", md: "20px 0", xl: "30px 0" }}
